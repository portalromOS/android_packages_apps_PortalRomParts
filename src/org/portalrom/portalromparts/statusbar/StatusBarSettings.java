...
import portalrom.preference.PortalRomSystemSettingListPreference;
...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    private PortalRomSystemSettingListPreference mQuickPulldown;
    private PortalRomSystemSettingListPreference mStatusBarClock;
    private PortalRomSystemSettingListPreference mStatusBarAmPm;
    private PortalRomSystemSettingListPreference mStatusBarBatteryShowPercent;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PortalRomSystemSettingListPreference statusBarBattery =
    ...
    private int getNetworkTrafficStatus() {
        return PortalRomSettings.Secure.getInt(getActivity().getContentResolver(),
                PortalRomSettings.Secure.NETWORK_TRAFFIC_MODE, 0);
    }

    private int getClockPosition() {
        return PortalRomSettings.System.getInt(getActivity().getContentResolver(),
