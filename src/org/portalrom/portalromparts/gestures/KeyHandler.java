...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final String GESTURE_WAKEUP_REASON = "portalromparts-gesture-wakeup";
    ...
    public KeyHandler(final Context context) {
        ...
        mGestureWakeLock = mPowerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "PortalRomPartsGestureWakeLock");
        ...
        if (mProximityWakeSupported) {
            ...
            mDefaultProximity = mContext.getResources().getBoolean(
                    org.portalrom.platform.internal.R.bool.
                            config_proximityCheckOnWakeEnabledByDefault);

            mSensorManager = context.getSystemService(SensorManager.class);
            mProximitySensor = mSensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
            mProximityWakeLock = mPowerManager.newWakeLock(
                    PowerManager.PARTIAL_WAKE_LOCK, "PortalRomPartsProximityWakeLock");
        }
    ...
    public KeyEvent handleKeyEvent(final KeyEvent event) {
        ...
        if (action != 0 && !mEventHandler.hasMessages(GESTURE_REQUEST)) {
            ...
            final boolean proxWakeEnabled = PortalRomSettings.System.getInt(
                    mContext.getContentResolver(),
                    PortalRomSettings.System.PROXIMITY_ON_WAKE, mDefaultProximity ? 1 : 0) == 1;
    ...
    private void launchCamera() {
        ...
        final Intent intent = new Intent(portalrom.content.Intent.ACTION_SCREEN_CAMERA_GESTURE);
    ...
    private void doHapticFeedback() {
        ...
        if (mAudioManager.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
            final boolean enabled = PortalRomSettings.System.getInt(mContext.getContentResolver(),
                    PortalRomSettings.System.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK, 1) != 0;
            if (enabled) {
