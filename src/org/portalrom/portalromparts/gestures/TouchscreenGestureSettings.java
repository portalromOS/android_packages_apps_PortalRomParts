...
package org.portalrom.portalromparts.gestures;
...
import portalrom.hardware.TouchscreenGesture;
...
public class TouchscreenGestureSettings extends SettingsPreferenceFragment
    ...
    private void initTouchscreenGestures() {
        final PortalRomHardwareManager manager = PortalRomHardwareManager.getInstance(getContext());
    ...
    private class TouchscreenGesturePreference extends ListPreference {
        ...
        public boolean callChangeListener(final Object newValue) {
            ...
            final PortalRomHardwareManager manager = PortalRomHardwareManager.getInstance(mContext);
    ...
    public static void restoreTouchscreenGestureStates(final Context context) {
        ...
        final PortalRomHardwareManager manager = PortalRomHardwareManager.getInstance(context);
    ...
    private static boolean isTouchscreenGesturesSupported(final Context context) {
        final PortalRomHardwareManager manager = PortalRomHardwareManager.getInstance(context);
        return manager.isSupported(PortalRomHardwareManager.FEATURE_TOUCHSCREEN_GESTURES);
    }
