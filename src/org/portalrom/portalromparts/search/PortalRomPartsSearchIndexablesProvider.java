...
import org.portalrom.portalromparts.search.Searchable.SearchIndexProvider;
import org.portalrom.internal.portalromparts.PartInfo;
import org.portalrom.internal.portalromparts.PartsList;
 ...
 */
public class PortalRomPartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = PortalRomPartsSearchIndexablesProvider.class.getSimpleName();
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_ICON_RESID] = raw.iconResId > 0 ? raw.iconResId :
                        (i.getIconRes() > 0 ? i.getIconRes() : R.drawable.ic_launcher_portalrom);
