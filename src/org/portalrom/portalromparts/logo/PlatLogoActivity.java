...
package org.portalrom.portalromparts.logo;
...
public class PlatLogoActivity extends Activity {
    ...
    private class PBackground extends Drawable {
        ...
        public void draw(Canvas canvas) {
             ...
             * Sort of hacky. The PortalRom logo can be built with a bunch of circles.
    ...
    private void checkLongPressTimeout() {
        if (mTouchHeld > 0 && mTapCount >= 5) {
            if (System.currentTimeMillis() - mTouchHeld >= LONG_PRESS_TIMEOUT) {
                ...
                mLayout.post(() -> {
                    try {
                        startActivity(new Intent("org.portalrom.portalromparts.EASTER_EGG")
