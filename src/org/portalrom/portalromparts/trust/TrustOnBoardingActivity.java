 ...
 */
package org.portalrom.portalromparts.trust;
...
public class TrustOnBoardingActivity extends AppCompatActivity {
    ...
    private void openTrustSettings() {
        ...
        startActivity(new Intent("org.portalrom.portalromparts.TRUST_INTERFACE"));
        finish();
    }
    ...
    private void setOnboardingCompleted() {
        PortalRomSettings.System.putInt(getContentResolver(),
                PortalRomSettings.System.TRUST_INTERFACE_HINTED, 1);
