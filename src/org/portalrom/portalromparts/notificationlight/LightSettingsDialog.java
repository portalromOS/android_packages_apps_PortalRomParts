...
import org.portalrom.internal.notification.PortalRomNotification;
...
public class LightSettingsDialog extends AlertDialog implements
    ...
    private void updateLed() {
        ...
        b.putBoolean(PortalRomNotification.EXTRA_FORCE_SHOW_LIGHTS, true);
        if  (mLedBrightness > 0 && mLedBrightness < LedValues.LIGHT_BRIGHTNESS_MAXIMUM) {
            b.putInt(PortalRomNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, mLedBrightness);
        }
        b.putInt(PortalRomNotification.EXTRA_FORCE_COLOR, color);
        b.putInt(PortalRomNotification.EXTRA_FORCE_LIGHT_ON_MS, speedOn);
        b.putInt(PortalRomNotification.EXTRA_FORCE_LIGHT_OFF_MS, speedOff);
