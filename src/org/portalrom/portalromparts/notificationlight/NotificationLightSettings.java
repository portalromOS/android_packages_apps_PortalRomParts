...
import org.portalrom.portalromparts.widget.PackageListAdapter;
import org.portalrom.portalromparts.widget.PackageListAdapter.PackageItem;
...
import portalrom.preference.PortalRomSystemSettingSwitchPreference;
import portalrom.preference.SystemSettingMainSwitchPreference;
...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    private PortalRomSystemSettingSwitchPreference mCustomEnabledPref;
    private PortalRomSystemSettingSwitchPreference mScreenOnLightsPref;
    private PortalRomSystemSettingSwitchPreference mAutoGenerateColors;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAutoGenerateColors = findPreference(PortalRomSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO);

        // Advanced light settings
        mScreenOnLightsPref =
                findPreference(PortalRomSettings.System.NOTIFICATION_LIGHT_SCREEN_ON);
        mScreenOnLightsPref.setOnPreferenceChangeListener(this);
        mCustomEnabledPref =
                findPreference(PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE);
        ...
        if (!mMultiColorLed) {
            ...
            watch(PortalRomSettings.System.getUriFor(
    ...
    private void refreshDefault() {
        ...
        int color = PortalRomSettings.System.getInt(resolver,
                PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor);
        int timeOn = PortalRomSettings.System.getInt(resolver,
                PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn);
        int timeOff = PortalRomSettings.System.getInt(resolver,
                PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, mDefaultLedOff);

        mDefaultPref.setAllValues(color, timeOn, timeOff);

        // Get Missed call and Voicemail values
        if (mCallPref != null) {
            int callColor = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor);
            int callTimeOn = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn);
            int callTimeOff = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, mDefaultLedOff);

            mCallPref.setAllValues(callColor, callTimeOn, callTimeOff);
        }

        if (mVoicemailPref != null) {
            int vmailColor = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor);
            int vmailTimeOn = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn);
            int vmailTimeOff = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, mDefaultLedOff);
    ...
    private int getInitialColorForPackage(String packageName) {
        boolean autoColor = PortalRomSettings.System.getInt(getActivity().getContentResolver(),
                PortalRomSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO, mMultiColorLed ? 1 : 0) == 1;
    ...
    private boolean parsePackageList() {
        final String baseString = PortalRomSettings.System.getString(
    ...
    private void savePackageList(boolean preferencesUpdated) {
        ...
        PortalRomSettings.System.putString(getActivity().getContentResolver(),
                PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES, value);
    }
    ...
    protected void updateValues(String packageName, Integer color, Integer timeon,
        ...
        if (packageName.equals(DEFAULT_PREF)) {
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, color);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, timeon);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, timeoff);
            refreshDefault();
            return;
        } else if (packageName.equals(MISSED_CALL_PREF)) {
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, color);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, timeon);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, timeoff);
            refreshDefault();
            return;
        } else if (packageName.equals(VOICEMAIL_PREF)) {
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, color);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, timeon);
            PortalRomSettings.System.putInt(resolver,
                    PortalRomSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, timeoff);
            refreshDefault();
            return;
        }
    ...
    public static final SummaryProvider SUMMARY_PROVIDER = (context, key) -> {
        if (Settings.System.getInt(context.getContentResolver(),
            ...
            if (PortalRomSettings.System.getInt(context.getContentResolver(),
                    PortalRomSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO, 1) == 1) {
