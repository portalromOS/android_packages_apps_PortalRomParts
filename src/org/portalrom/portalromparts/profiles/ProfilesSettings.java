...
public class ProfilesSettings extends SettingsPreferenceFragment
    ...
    public void onStart() {
        ...
        mProfileEnabler.getSwitch().setOnCheckedChangeListener((buttonView, isChecked) -> {
            PortalRomSettings.System.putInt(activity.getContentResolver(),
                    PortalRomSettings.System.SYSTEM_PROFILES_ENABLED, isChecked ? 1 : 0);
        });
    ...
    private void updateProfilesEnabledState() {
        ...
        mEnabled = PortalRomSettings.System.getInt(activity.getContentResolver(),
