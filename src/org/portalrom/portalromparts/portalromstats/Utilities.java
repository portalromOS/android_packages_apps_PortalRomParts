...
public class Utilities {
    ...
    public static boolean isStatsCollectionEnabled(Context context) {
        return PortalRomSettings.Secure.getInt(context.getContentResolver(),
                PortalRomSettings.Secure.STATS_COLLECTION, 1) != 0;
    }
    ...
    public static void setStatsCollectionEnabled(Context context, boolean enabled) {
        ...
        PortalRomSettings.Secure.putInt(context.getContentResolver(),
                PortalRomSettings.Secure.STATS_COLLECTION, enable);
    }
