...
package org.portalrom.portalromparts.input;
...
import org.portalrom.portalromparts.search.BaseSearchIndexProvider;
import org.portalrom.portalromparts.search.Searchable;
import org.portalrom.portalromparts.utils.DeviceUtils;
import org.portalrom.portalromparts.utils.TelephonyUtils;
import org.portalrom.internal.util.ScreenType;
...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHardware = PortalRomHardwareManager.getInstance(getActivity());
        ...
        final int torchLongPressPowerTimeout = PortalRomSettings.System.getInt(resolver,
                PortalRomSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT, 0);
        ...
        if (hasMenuKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    PortalRomSettings.System.KEY_MENU_ACTION, Action.MENU);
        ...
        if (hasAssistKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    PortalRomSettings.System.KEY_ASSIST_ACTION, Action.SEARCH);
            mAssistPressAction = initList(KEY_ASSIST_PRESS, pressAction);

            Action longPressAction = Action.fromSettings(resolver,
                    PortalRomSettings.System.KEY_ASSIST_LONG_PRESS_ACTION, Action.VOICE_SEARCH);
        ...
        if (hasAppSwitchKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    PortalRomSettings.System.KEY_APP_SWITCH_ACTION, Action.APP_SWITCH);
        ...
        if (hasCameraKey) {
            ...
            if (res.getBoolean(
                    org.portalrom.platform.internal.R.bool.config_singleStageCameraKey)) {
        ...
        if (hasVolumeKeys) {
            ...
            int swapVolumeKeys = PortalRomSettings.System.getInt(resolver,
                    PortalRomSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, 0);
            mSwapVolumeButtons = prefScreen.findPreference(KEY_SWAP_VOLUME_BUTTONS);
            if (mSwapVolumeButtons != null) {
                mSwapVolumeButtons.setChecked(swapVolumeKeys > 0);
            }

            final boolean volumePanelOnLeft = PortalRomSettings.Secure.getIntForUser(resolver,
                    PortalRomSettings.Secure.VOLUME_PANEL_ON_LEFT, 0, UserHandle.USER_CURRENT) != 0;
        ...
        if (mEnableTaskbar != null) {
            if (!isTablet(getContext()) || !hasNavigationBar()) {
                ...
                mEnableTaskbar.setChecked(PortalRomSettings.System.getInt(resolver,
    ...
    public void onResume() {
        ...
        if (mHomeAnswerCall != null) {
            final int incallHomeBehavior = PortalRomSettings.Secure.getInt(getContentResolver(),
                    PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR,
                    PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DEFAULT);
            final boolean homeButtonAnswersCall =
                (incallHomeBehavior == PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER);
    ...
    private void handleListChange(ListPreference pref, Object newValue, String setting) {
        ...
        PortalRomSettings.System.putInt(getContentResolver(), setting, Integer.valueOf(value));
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mBackLongPressAction ||
            ...
            handleListChange(mTorchLongPressPowerTimeout, newValue,
                    PortalRomSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT);
            return true;
            ...
            mHardware.set(PortalRomHardwareManager.FEATURE_KEY_SWAP, (Boolean) newValue);
            return true;
            ...
            PortalRomSettings.System.putInt(getContentResolver(),
                    PortalRomSettings.System.ENABLE_TASKBAR, ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return false;
    }
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        PortalRomSettings.System.putIntForUser(context.getContentResolver(),
                PortalRomSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0, UserHandle.USER_CURRENT);
    }

    private void updateDisableNavkeysOption() {
        boolean enabled = PortalRomSettings.System.getIntForUser(getActivity().getContentResolver(),
    ...
    private static boolean isKeySwapperSupported(Context context) {
        final PortalRomHardwareManager hardware = PortalRomHardwareManager.getInstance(context);
        return hardware.isSupported(PortalRomHardwareManager.FEATURE_KEY_SWAP);
    }
    ...
    public static void restoreKeyDisabler(Context context) {
        ...
        boolean enabled = PortalRomSettings.System.getIntForUser(context.getContentResolver(),
                PortalRomSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0;
    ...
    public static void restoreKeySwapper(Context context) {
        ...
        final PortalRomHardwareManager hardware = PortalRomHardwareManager.getInstance(context);
        hardware.set(PortalRomHardwareManager.FEATURE_KEY_SWAP,
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mSwapVolumeButtons) {
            ...
            PortalRomSettings.System.putInt(getActivity().getContentResolver(),
                    PortalRomSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, value);
        } else if (preference == mVolumePanelOnLeft) {
            PortalRomSettings.Secure.putIntForUser(getActivity().getContentResolver(),
                    PortalRomSettings.Secure.VOLUME_PANEL_ON_LEFT,
    ...
    private void handleToggleHomeButtonAnswersCallPreferenceClick() {
        PortalRomSettings.Secure.putInt(getContentResolver(),
                PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR, (mHomeAnswerCall.isChecked()
                        ? PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER
                        : PortalRomSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DO_NOTHING));
    }
